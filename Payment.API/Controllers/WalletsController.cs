...
namespace Payment.API.Controllers
{
    ...
    public class WalletsController : ControllerBase
    {
        ...
        public async Task<IActionResult> InitializationFundWallet([FromBody] FundWalletRequest request, string walletId)
        {
        ...
        [ProducesResponseType(StatusCodes.Status402PaymentRequired)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> FundWallets([FromBody] VerifyTransactionRequestDto reference, string walletId)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> LocalTransfer(string walletId, [FromBody] LocalTransferRequestDto request)
        {
