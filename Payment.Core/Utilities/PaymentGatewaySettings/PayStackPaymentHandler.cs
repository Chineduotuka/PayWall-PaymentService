...
namespace Payment.Core.Utilities.PaymentGatewaySettings
{
    public class PayStackPaymentHandler : IPayStackPaymentHandler
    {
        ...
        {
            return await PayStack.Transactions.InitializeTransaction(request.Email, request.Amount * 100, callbackUrl: "http://localhost:3000/dashboard");
        }
        ...
        {
            return await PayStack.Customers.CreateCustomer(request.Email, request.FirstName, request.LastName);
        }
